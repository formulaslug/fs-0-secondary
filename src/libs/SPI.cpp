...
void SPIClass::begin() {
  ...
  SPI0_CTAR0 = SPI_CTAR_FMSZ(7) | SPI_CTAR_PBR(0) | SPI_CTAR_BR(1) |
      SPI_CTAR_CSSCK(1);
  SPI0_CTAR1 = SPI_CTAR_FMSZ(15) | SPI_CTAR_PBR(0) | SPI_CTAR_BR(1) |
      SPI_CTAR_CSSCK(1);
...
static inline unsigned char __interruptsStatus(void) __attribute__((
...
void SPIClass::setDataMode(uint8_t _pin, uint8_t _mode) {
  ...
  SPI_ConfigureNPCS(spi, ch, mode[ch] | SPI_CSR_SCBR(
      divider[ch]) | SPI_CSR_DLYBCT(1));
}
